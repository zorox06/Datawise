...
const navLinks = [
  ...
  { name: "Analytics",     href: "#infra"         },
  { name: "Integrations",  href: "#integrations"  },
  { name: "AI Reports",    href: "#security"      },
];
      ...
      >
        ...
        >
          ...
          <a href="#" className="flex items-center gap-2 group">
            <span className={`font-display tracking-tight transition-all duration-500 ${isScrolled ? "text-xl text-foreground" : "text-2xl text-white"}`}>DATAWISE</span>
          ...
          <div className="hidden md:flex items-center gap-4">
            <a href="/auth/login" className={`transition-all duration-500 ${isScrolled ? "text-xs text-foreground/70 hover:text-foreground" : "text-sm text-white/70 hover:text-white"}`}>
              Sign in
            </a>
            <a href="/auth/sign-up">
              <Button
      ...
      >
        <div className="flex flex-col h-full px-8 pt-28 pb-8">
          ...
          >
            ...
            <a href="/auth/sign-up" className="flex-1">
              <Button 
